...
def pt_operator_registry(
        ...
        **kwargs):
    updated_args = get_pt_operator_registry_dict(name, deps, train, labels, env, template_select, enforce_traced_op_list, pt_allow_forced_schema_registration, **kwargs)
    fb_xplat_cxx_library(**updated_args)
